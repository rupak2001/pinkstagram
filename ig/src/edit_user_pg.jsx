...
var Editpg = (props) => {
    return (
        <div id="editpgd" className='w-screen flex justify-center mt-20 md:mt-32 items-center overflow-y-hidden'>
            <div className=" bg-gray-500 h-96 w-[38rem] flex flex-col rounded-lg border-2 border-pink-400 justify-center items-center justify-evenly">
                <div id="editpgd1" className='flex flex-col justify-center items-center justify-evenly'>
                    <label>
                        <img id="pp" className='w-36 h-36 rounded-full cursor-pointer border-2' src={props.pp} alt="pp" />
