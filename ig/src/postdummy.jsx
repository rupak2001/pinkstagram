    ...
    return (
        <div id="p_dummywh" className='w-screen sm:w-128  mt-4 md:mt-4 bg-white'>
            ...
            <div id="inpbox1" className='h-10 flex flex-row items-center border-l-2 border-r-2 '>
                ...
                <input className=" h-7 w-7 cursor-pointer" type="image" onClick={props.compg} alt="comment" id = {props.commentbutid} class="comment" src="https://cpng.pikpng.com/pngl/s/44-445926_circular-speech-bubble-outline-comments-comment-icon-instagram.png"></input>
            </div>
